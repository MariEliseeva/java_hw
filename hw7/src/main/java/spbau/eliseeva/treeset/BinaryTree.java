...
public class BinaryTree<E> extends AbstractSet<E> {
     ...
     */
    public BinaryTree() {
        this.comparator = (E a, E b) -> ((Comparable<E>) a).compareTo(b);
    }
    ...
    /**
     * Returns iterator of the BinaryTree
    ...
    /**
     * Returns iterator, which goes from the end to the begin.
    ...
    /** Iterator of going from the begin to the end.*/
    ...
    /** Iterator going from the end to the begin.*/
